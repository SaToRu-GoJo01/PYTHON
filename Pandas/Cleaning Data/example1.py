...
data = {
    ...
    "Date": ['2020/12/01', '2020/12/02', '2020/12/03', '2020/12/04', '2020/12/05', '2020/12/06', '2020/12/07', '2020/12/08', '2020/12/09', '2020/12/10', 
             ...
             '2020/12/20', '2020/12/21', None, '2020/12/23', '2020/12/24', '2020/12/25', '2020/12/26', '2020/12/27', '2020/12/28', '2020/12/29', '2020/12/30', 
             '2020/12/31'],
...
#removes the NA values and then it will return a different dataframe and will not make any changes to the existing one
removed = df.dropna()

print(removed)

# using inplace attribute we can make changes to the existing dataframe

# df.dropna(inplace=True)
# print(df)


# fill the data frame using some values
var = df.copy()
...
var2["Calories"].fillna(15000, inplace=True)
print(var2)


var3 = df.copy()

x = var3["Calories"].mean()
var3.fillna(x,inplace=True)
print(var3)


var4 = df.copy()

x = var4["Calories"].median()
var4.fillna(x,inplace=True)
print(var4)


var5 = df.copy()
x = var5["Calories"].mode()[0]
var5.fillna(x,inplace=True)
print(var5)